...
namespace com.google.zxing
{
	...
	public sealed class BarcodeFormat
	{
        ...
        //WP7 Port: Added types for UPC_EAN and All_1D readers
        /// <summary>MultiReader for all 1D barcode types. </summary>
        public static readonly BarcodeFormat ALL_1D = new BarcodeFormat("ALL_1D");
        /// <summary>MultiReader for all UPC and EAN types. </summary>
        public static readonly BarcodeFormat UPC_EAN = new BarcodeFormat("UPC_EAN");		
