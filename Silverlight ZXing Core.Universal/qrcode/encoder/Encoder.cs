...
namespace com.google.zxing.qrcode.encoder
{
	...
	public sealed class Encoder
	{
		...
		public static void  encode(string content, ErrorCorrectionLevel ecLevel, System.Collections.Generic.Dictionary<Object,Object> hints, QRCode qrCode)
		{
			
			string encoding = (hints != null && hints.ContainsKey(EncodeHintType.CHARACTER_SET))?(string) hints[EncodeHintType.CHARACTER_SET]:null;
			if (encoding == null)
			{
